...
namespace AFUT.Tests.UnitTests.Reports.TypesOfReports
{
    ...
    public class ListsTests : IClassFixture<AppConfig>
    {
        private readonly AppConfig _config;
        private readonly IPookieDriverFactory _driverFactory;
        private readonly ITestOutputHelper _output;

        public ListsTests(AppConfig config, ITestOutputHelper output)
        {
        ...
        public void VerifyListsReportCriteriaAndFilters()
        {
            ...
            // Use the helper method to test the complete Lists filter functionality
        ...
        public void VerifyListsReportPdfContentMatchesSelectedCriteria()
        {
            ...
            try
            {
                ...
                // Step 1: Navigate to Reports > Lists
                _output.WriteLine("[INFO] Navigating to Lists reports...");
                ...
                // Get count of all Lists reports
                var reportCount = ReportFilterHelper.GetReportCount(driver, _output);
                _output.WriteLine($"\n{'=',-60}");
                _output.WriteLine($"[INFO] Testing PDF generation for all {reportCount} Lists reports");
                _output.WriteLine($"{'=',-60}");

                var random = new Random();

                // Test each Lists report
                ...
                _output.WriteLine($"\n{'=',-60}");
                _output.WriteLine($"[PASS] All {reportCount} Lists reports PDF validation completed successfully");
                _output.WriteLine($"{'=',-60}");
            }
            finally
            {
